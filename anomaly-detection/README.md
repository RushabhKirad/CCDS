...
- **Local Protection**: Direct ML backend integration
- **Easy Setup**: Single command deployment
- **WebSocket Alerts**: Live security notifications

## 🏗️ Architecture
```
Local Traffic → ML Backend (8080) → Database API (5000) → Dashboard (3000)
```
...
## 💰 Cost
**$0/month** - Completely free local deployment
